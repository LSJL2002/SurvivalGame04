...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField] float attackDelay = 0.3f;       // 애니메이션 타이밍(이벤트 없을 때 사용)
    [SerializeField] bool useAnimationEvent = true;  // 애니메이션 이벤트로 타격할지
    ...
    {
        return attackDamage; // 위 ApplyEnemyType에서 세팅됨
    }
